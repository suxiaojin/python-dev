...
继承：
        super函数用于子类调用父类方法
            super(子类,self).func()
class Persion:
    def __init__(self,name,hight,weight,country):
        self.name=name
class chinese(Persion)
    def __init(self,name,hight,weight,country,id):
        super(chinese,self).__init__(name,hight,weight,country)   #子类chinese继承父类persion
        self.id=id                                                #添加自己的属性id
